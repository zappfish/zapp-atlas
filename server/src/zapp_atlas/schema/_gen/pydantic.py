...
linkml_meta = LinkMLMeta(
    {
        ...
        "prefixes": {
            ...
            "ZFIN": {"prefix_prefix": "ZFIN", "prefix_reference": "https://zfin.org/"},
            "ZP": {
                "prefix_prefix": "ZP",
            ...
            "zebrafish_toxicology_atlas_schema": {
                "prefix_prefix": "zebrafish_toxicology_atlas_schema",
...
class ZappEntity(ConfiguredBaseModel):
    ...
    id: int = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ZappEntity"]}},
    )
...
class ZfinEntity(ConfiguredBaseModel):
    ...
    zfin_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ZfinEntity"]}},
    )
...
class Study(ZappEntity):
    ...
    experiment: Optional[list[Experiment]] = Field(
        default=None,
        description="""The experiment in a study.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Study"]}},
    )
    ...
    annotator: Optional[list[str]] = Field(
        default=None,
...
class Experiment(ZappEntity):
    ...
    standard_rearing_condition: Optional[bool] = Field(
        default=None,
...
class PhenotypeObservationSet(ZappEntity):
    ...
    image: Optional[list[Image]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["PhenotypeObservationSet"]}},
    )
    phenotype: Optional[list[Phenotype]] = Field(
        default=None,
        description="""The phenotype observed.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["PhenotypeObservationSet"]}},
    )
    control_image: Optional[list[ControlImage]] = Field(
        default=None,
        description="""Image associated with this control.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["PhenotypeObservationSet", "Control"]}
        },
    )
    id: int = Field(
        default=...,
...
class Phenotype(ZappEntity):
    ...
    stage: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Phenotype"]}},
    )
    prevalence: Optional[QuantityValue] = Field(
        default=None,
    ...
    phenotype_term_id: Optional[PhenotypeTerm] = Field(
        default=None,
...
class Control(ZappEntity):
    ...
    control_type: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Control"]}},
    )
    vehicle_if_treated: Optional[VehicleEnumeration] = Field(
        default=None,
    ...
    comment: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["Control", "ExposureEvent", "StressorChemical"]
            }
        },
    )
    control_image: Optional[list[ControlImage]] = Field(
...
class ExposureEvent(ZappEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "exact_mappings": ["biolink:ExposureEvent"],
            "from_schema": "https://w3id.org/sierra-moxon/zebrafish-toxicology-atlas-schema",
        }
    )

    stressor: Optional[list[StressorChemical]] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ExposureEvent"]}},
    )
    vehicle: Optional[list[VehicleEnumeration]] = Field(
        default=None,
        description="""The substance or medium used to deliver a stressor.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExposureEvent"]}},
    )
    route: Optional[ExposureRouteEnum] = Field(
        default=None,
        description="""The route of exposure.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExposureEvent"]}},
    )
    regimen: Optional[Regimen] = Field(
        default=None,
        description="""The regimen for the exposure.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExposureEvent"]}},
    )
    exposure_start_stage: Optional[str] = Field(
        default=None,
        description="""The developmental stage of fish when exposure started.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExposureEvent"]}},
    )
    exposure_end_stage: Optional[str] = Field(
        default=None,
...
class Regimen(ZappEntity):
    ...
    exposure_regimen_type: Optional[ExposureRegimenTypeEnum] = Field(
        default=None,
        description="""The type of exposure regimen (e.g., continuous or repeated).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Regimen"]}},
    )
    interval_between_individual_exposures: Optional[QuantityValue] = Field(
        default=None,
        description="""Interval between individual exposures.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Regimen"]}},
    )
    total_exposure_duration: Optional[QuantityValue] = Field(
        default=None,
        description="""Time between first and last individual exposure.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Regimen"]}},
    )
    individual_exposure_duration: Optional[QuantityValue] = Field(
        default=None,
        description="""Individual exposure duration.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Regimen"]}},
    )
    number_of_individual_exposure: Optional[int] = Field(
        default=None,
...
class StressorChemical(ZappEntity):
    ...
    chemical_id: ChemicalEntity = Field(
        default=...,
        description="""Chemical identifier (CHEBI, CAS, or UUID).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["StressorChemical"]}},
    )
    ...
    concentration: QuantityValue = Field(
        default=...,
...
class Image(ZappEntity):
    ...
    magnification: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Image", "ControlImage"]}},
    )
...
class ControlImage(ZappEntity):
    ...
    phenotype_comments: Optional[str] = Field(
        default=None,
...
class ChemicalEntity(OntologyEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "exact_mappings": ["biolink:ChemicalEntity"],
            "from_schema": "https://w3id.org/sierra-moxon/zebrafish-toxicology-atlas-schema",
        }
    )
    ...
    uri: str = Field(
        default=...,
        description="""URI identifier for the chemical entity (CHEBI or CAS URI).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ChemicalEntity"]}},
    )
...
class PhenotypeTerm(OntologyEntity):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "exact_mappings": ["biolink:PhenotypicFeature"],
            "from_schema": "https://w3id.org/sierra-moxon/zebrafish-toxicology-atlas-schema",
        }
    )
    ...
    term_uri: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["PhenotypeTerm"]}},
    )
    term_label: Optional[str] = Field(
        default=None,
...
class Fish(ZfinEntity):
    ...
    name: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Fish"]}},
    )
    zfin_id: str = Field(
        default=...,
        description="""ZFIN database identifier.""",
...
class QuantityValue(ConfiguredBaseModel):
    ...
    unit: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["QuantityValue"]}},
    )
