...
class StudyAnnotator(Base):
    ...
    Study_id: Mapped[int] = mapped_column(
        Integer(), ForeignKey("Study.id"), primary_key=True
    )
...
class ExposureEventVehicle(Base):
    ...
    ExposureEvent_id: Mapped[int] = mapped_column(
        Integer(), ForeignKey("ExposureEvent.id"), primary_key=True
    )
    vehicle: Mapped[str] = mapped_column(
        Enum("ethanol", "dmso", name="VehicleEnumeration"), primary_key=True
    )
...
class ChemicalEntitySynonym(Base):
    ...
    ChemicalEntity_uri: Mapped[int] = mapped_column(
        Integer(), ForeignKey("ChemicalEntity.uri"), primary_key=True
    )
...
class Experiment(ZappEntity):
    ...
    fish_zfin_id: Mapped[Optional[str]] = mapped_column(
        Text(), ForeignKey("Fish.zfin_id")
    )
    ...
    control: Mapped[List["Control"]] = relationship(
        foreign_keys="[Control.Experiment_id]"
    )
    ...
    exposure_event: Mapped[List["ExposureEvent"]] = relationship(
        foreign_keys="[ExposureEvent.Experiment_id]"
    )
...
class PhenotypeObservationSet(ZappEntity):
    ...
    id: Mapped[int] = mapped_column(Integer(), primary_key=True)
    ExposureEvent_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("ExposureEvent.id")
    )
    ...
    image: Mapped[List["Image"]] = relationship(
        foreign_keys="[Image.PhenotypeObservationSet_id]"
    )
    ...
    phenotype: Mapped[List["Phenotype"]] = relationship(
        foreign_keys="[Phenotype.PhenotypeObservationSet_id]"
    )
    ...
    control_image: Mapped[List["ControlImage"]] = relationship(
        foreign_keys="[ControlImage.PhenotypeObservationSet_id]"
    )
...
class Phenotype(ZappEntity):
    ...
    severity: Mapped[Optional[str]] = mapped_column(
        Enum("mild", "moderate", "severe", name="SeverityEnum")
    )
    id: Mapped[int] = mapped_column(Integer(), primary_key=True)
    PhenotypeObservationSet_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("PhenotypeObservationSet.id")
    )
    prevalence_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("QuantityValue.id")
    )
    prevalence: Mapped[Optional["QuantityValue"]] = relationship(
        foreign_keys=[prevalence_id]
    )
    phenotype_term_id_term_uri: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("PhenotypeTerm.term_uri")
    )
    phenotype_term_id: Mapped[Optional["PhenotypeTerm"]] = relationship(
        foreign_keys=[phenotype_term_id_term_uri]
    )
...
class Control(ZappEntity):
    ...
    vehicle_if_treated: Mapped[Optional[str]] = mapped_column(
        Enum("ethanol", "dmso", name="VehicleEnumeration")
    )
    comment: Mapped[Optional[str]] = mapped_column(Text())
    id: Mapped[int] = mapped_column(Integer(), primary_key=True)
    Experiment_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("Experiment.id")
    )
    ...
    control_image: Mapped[List["ControlImage"]] = relationship(
        foreign_keys="[ControlImage.Control_id]"
    )
...
class ExposureEvent(ZappEntity):
    ...
    regimen_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("Regimen.id")
    )
    ...
    stressor: Mapped[List["StressorChemical"]] = relationship(
        foreign_keys="[StressorChemical.ExposureEvent_id]"
    )

    vehicle_rel: Mapped[List["ExposureEventVehicle"]] = relationship()
    vehicle: AssociationProxy[List[str]] = association_proxy(
        "vehicle_rel", "vehicle", creator=lambda x_: ExposureEventVehicle(vehicle=x_)
    )
    ...
    phenotype_observation: Mapped[List["PhenotypeObservationSet"]] = relationship(
        foreign_keys="[PhenotypeObservationSet.ExposureEvent_id]"
    )
...
class Regimen(ZappEntity):
    ...
    exposure_regimen_type: Mapped[Optional[str]] = mapped_column(
        Enum("continuous", "repeated", name="ExposureRegimenTypeEnum")
    )
    number_of_individual_exposure: Mapped[Optional[int]] = mapped_column(Integer())
    id: Mapped[int] = mapped_column(Integer(), primary_key=True)
    interval_between_individual_exposures_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("QuantityValue.id")
    )
    interval_between_individual_exposures: Mapped[Optional["QuantityValue"]] = (
        relationship(foreign_keys=[interval_between_individual_exposures_id])
    )
    total_exposure_duration_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("QuantityValue.id")
    )
    total_exposure_duration: Mapped[Optional["QuantityValue"]] = relationship(
        foreign_keys=[total_exposure_duration_id]
    )
    individual_exposure_duration_id: Mapped[Optional[int]] = mapped_column(
        Integer(), ForeignKey("QuantityValue.id")
    )
    individual_exposure_duration: Mapped[Optional["QuantityValue"]] = relationship(
        foreign_keys=[individual_exposure_duration_id]
    )
...
class StressorChemical(ZappEntity):
    ...
    chemical_id_uri: Mapped[int] = mapped_column(
        Integer(), ForeignKey("ChemicalEntity.uri")
    )
    chemical_id: Mapped[Optional["ChemicalEntity"]] = relationship(
        foreign_keys=[chemical_id_uri]
    )
    concentration_id: Mapped[int] = mapped_column(
        Integer(), ForeignKey("QuantityValue.id")
    )
    concentration: Mapped[Optional["QuantityValue"]] = relationship(
        foreign_keys=[concentration_id]
    )
...
class ChemicalEntity(OntologyEntity):
    ...
    synonym: AssociationProxy[List[str]] = association_proxy(
        "synonym_rel", "synonym", creator=lambda x_: ChemicalEntitySynonym(synonym=x_)
    )
